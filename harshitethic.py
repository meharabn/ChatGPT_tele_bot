...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5820996654:AAFrg9XKE4OBILp2vFuOr4qBW3jjWZmMmhc"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Talk with bot'
username = 'talk_anything_with_bot'
