...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5989905777:AAEbtfT-JjwbyF2MlAda92w6oIgAUucpV-c"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'hooman helper :3'
username = 'hooman_helper_bot'
